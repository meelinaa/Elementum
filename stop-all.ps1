...
Get-Process -Name "Elementum.Api", "Elementum.Worker", "Elementum.Cli", "dotnet" -ErrorAction SilentlyContinue | Where-Object { $_.Path -like "*Elementum*" } | Stop-Process -Force -ErrorAction SilentlyContinue
