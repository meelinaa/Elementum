...
public class OptimisticConcurrencyTests
{
    ...
    public async Task DailyPriceSummary_WhenConcurrentModificationsOccur_HasConcurrencyTokenConfigured()
    {
        ...
        // Simulate second DbContext instance loading the same entity
        var options = new DbContextOptionsBuilder<ElementumDbContext>()
            .UseInMemoryDatabase(name, root)
            .Options;
        ...
        // InMemory EF Core enforces ConcurrencyCheck attributes
    ...
    public async Task DailyCandleAggregator_HandlesConcurrencyConflictTransparently()
    {
        ...
        // Aggregate summaries without errors
